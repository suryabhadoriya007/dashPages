        ...
        <div className="container " id='overview-10'>
                   ...
                   <div className='row'>
                     ...
                     <img src={fb1}/>
                       ...
                       <div className='col-md-5  ana-10 mt-3 ml-3'>
                           <h5>Connect your Facebook profile to get profile analytics for your Facebook listing</h5>
                           </div>
                           <div className='col-md-3 mt-4 ml-3 '>
                           <a href="#" className="btn btn-analy  "><h6>Connect</h6> </a>
                           </div>
                   </div>
                  </div>
                  <div className='col-md-5 anacard ml-2 '>
            ...
            <div className='container analytic-11'>
               ...
               <div className='row mb-4  mt-3'>
                   ...
                   <a href="#"><p>This Week</p> </a>
                   </div>
                   <div className='col-md-6'>
                   <a href="#" className="btn btn-analytic-13"><h6>Download Report</h6> </a>
                   </div>
               </div>
               <div className='row'>
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <tr >
                      <th scope="row" className='analytics-17'>Consolidated</th>
                      <td>2636</td>
                      <td>10876</td>
                      <td>213</td>
                      <td>543</td>
                    ...
                    <tr>
                      <th scope="row" className='analytics-17'>Google</th>
                      <td>65</td>
                      <td>65</td>
                      <td>112</td>
                      <td>453</td>
                    ...
                    <tr>
                      <th scope="row" className='analytics-17'>Bing</th>
                      <td>785</td>
                      <td>345</td>
                      <td>432</td>
                      <td>76</td>
