...
import es_img1 from '../src/images/es_img1.png'
import edit from '../src/images/edit.png'
import delete_icon from '../src/images/delete_icon.png'


export default class Email_setting extends Component {
    render() {
        return (
            <div>
                ...
                <MDBRow>
                     <MDBCol className='profile_container' md='8' style={{padding:'43px 25px'}}>
                               <MDBRow>
                                 <MDBCol md='2'>
                                    <img src={es_img1} alt='es_img1' className='responsive' id='vl_img1'/>
                               
                                 </MDBCol>
                                 <MDBCol md='6'>
                                <div id='es_heading'>Dolce Vita Hair Salon</div>
                            <div className='es_contant'>Orlando best styles</div>
                            <div className='es_contant' style={{marginTop:'2%'}}>Agency Email: Example123@gmail.com</div>
                      ...
                      <MDBCol  style={{textAlign:'center'}} md='4'>
                        <div className='profile_container' style={{marginRight:'-10px'}}>
                  ...
                  <MDBRow className='profile_container' >
                    <MDBCol className='es_table_font1' md='4'>Notification Email</MDBCol>
                    <MDBCol className='es_table_font1' md='4'>Email Frequency</MDBCol>
                    <MDBCol className='es_table_font1' md='4'>Action</MDBCol>
                  </MDBRow>
                  <MDBRow className='profile_container' >
                    <MDBCol className='es_table_font1' md='4'>Profile Complrtion Email</MDBCol>
                    <MDBCol className='es_table_font1' md='4'>Email Frequency</MDBCol>
